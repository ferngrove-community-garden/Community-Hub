    ...
    <div className="page-shell flex min-h-screen flex-col">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col px-5 py-6 sm:px-8 lg:px-10 lg:py-8">
        <header className="cartoon-panel rounded-[2rem] px-5 py-4 sm:px-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="min-w-0">
              <Link href="/" className="section-title inline-block text-xl leading-tight font-semibold text-[var(--leaf-deep)] sm:text-2xl">
                Fern Grove Community Garden
              </Link>
              <p className="mt-1 text-[11px] leading-5 font-bold tracking-[0.08em] text-[var(--muted)] uppercase sm:text-sm">
        ...
        <footer className="cartoon-panel mt-2 rounded-[2rem] px-5 py-5 sm:px-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="min-w-0">
              <p className="section-title text-xl leading-tight font-semibold text-[var(--leaf-deep)] sm:text-2xl">Fern Grove Community Garden</p>
              <p className="mt-1 max-w-2xl text-sm leading-6 text-[var(--muted)]">
                A growing online home for events, updates, volunteer sessions, and simple garden admin tools.
              </p>
            </div>
            <div className="flex flex-wrap gap-2 text-sm font-bold text-[var(--leaf-deep)] md:justify-end">
              <Link href="/events" className="site-nav-link">
                Calendar
              </Link>
              <Link href="/updates" className="site-nav-link">
                Updates
              </Link>
