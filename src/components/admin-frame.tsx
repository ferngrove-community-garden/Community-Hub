        ...
        <header className="cartoon-panel rounded-[2rem] bg-[var(--sky)] px-5 py-5 sm:px-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-[var(--leaf-deep)] sm:text-sm">Admin area</p>
              <h1 className="section-title mt-2 text-3xl leading-tight font-semibold text-[var(--leaf-deep)] sm:text-4xl lg:text-5xl">
